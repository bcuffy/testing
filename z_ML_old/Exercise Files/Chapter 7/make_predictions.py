...
predicted_home_values = model.predict(house_to_value)
...
predicted_value2 = predicted_home_values[1]

print("This house has an estimated value of ${:,.2f}".format(predicted_value))
print("This house has an estimated value of ${:,.2f}".format(predicted_value2))
